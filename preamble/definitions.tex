...
\renewcommand{\quote}[2]{{\color{colthree}\itshape``#1''\par}\vspace*{3pt}{\color{gray}\raggedleft\scriptsize#2\par}}
\newcommand{\ra}{$\rightarrow$\xspace}
\newcommand{\bad}[1]{\textcolor{OrangeRed}{#1}}
\NewDocumentCommand{\header}{m O{\normalsize} O{colthree}}{{\color{#3}#2\bfseries#1}}
\NewDocumentCommand{\edu}{O{100} m m m m}{\begin{minipage}{.3\textwidth}\header{#2}[\normalsize][colthree!#1!black]\\[2pt]\footnotesize#3\\#4\\#5\end{minipage}}
